...
import tasks.gimnasios.SacarLiderGymTask;

public class SacarLiderGymComando implements CommandExecutor {
    ...
    public static CommandSpec getComandSpec() {
        ...
        builderCS.permission("adicionalesbyuc.comandos.admin.gym.sacarlider");
        builderCS.executor(new SacarLiderGymComando());
        builderCS.arguments(
    ...
    public CommandResult execute(CommandSource src, CommandContext args) throws CommandException {
        if (src instanceof Player) {
            ...
            Task.builder().execute(new SacarLiderGymTask(gym, new Jugador((player)), new Jugador((lider))))
                    .async()
